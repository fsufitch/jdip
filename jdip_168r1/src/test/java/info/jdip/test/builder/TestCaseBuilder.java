...
import info.jdip.test.builder.h32.H32Location;
import info.jdip.test.builder.h32.H32Power;
...
public class TestCaseBuilder<L extends TestLocation, P extends TestPower> {
    ...
    public static TestCaseBuilder<H32Location, H32Power> h32(Phase.SeasonType seasonType, int year, Phase.PhaseType phaseType) {
        return new TestCaseBuilder<>(Variant.H32, new Phase(seasonType, year, phaseType));
    }
